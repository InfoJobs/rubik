$('document').ready(function(){
        ...
        function modalPage() {
            if (window.innerWidth < 480) {
                ...
                elBtnCancel.classList.add('iconfont-Close');
                elBtnCancel.classList.add('iconfont-22px');
                elBtnCancel.classList.add('hit-area');
                ...
                elBtnCancel.classList.remove('iconfont-Close');
                elBtnCancel.classList.remove('iconfont-22px');
                elBtnCancel.classList.remove('hit-area');
